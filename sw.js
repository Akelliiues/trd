...
const CACHE_NAME = 'tradingtools-v2.5.8';
...
const STATIC_ASSETS = [
    ...
    '/index.html?v=2.5.7',
    '/styles.css?v=2.5.7',
    '/manifest.json?v=2.5.7',
    '/js/app.js?v=2.5.7',
    '/js/chart-engine.js?v=2.5.7',
    '/js/indicators.js?v=2.5.7',
    '/js/lightweight-charts.js?v=2.5.7',
    '/js/replay-engine.js?v=2.5.7',
    '/js/volume-profile.js?v=2.5.7',
    '/js/footprint.js?v=2.5.7',
    '/js/patterns.js?v=2.5.7',
    '/js/journal.js?v=2.5.7',
    '/js/watchlist.js?v=2.5.7',
    '/js/resampler.js?v=2.5.7',
    '/icons/icon.svg',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
